  ...
  const groups = [
    {
      ...
      rows: [
        ...
        { icon: <Wallet size={17} />, t: 'Talktime', s: 'Available balance', right: state.wallet && <span className="text-[13px] font-bold text-gold">{beans(state.wallet.displayBeans)}</span>, to: '/settings/talktime' },
